...
function em1(){var c="benjoAcvuufsgmzhspvq/ofu";var addr="mailto:";for(var i=0;i<c.length;i++)addr+=String.fromCharCode(c.charCodeAt(i)-1);window.location.href=addr;}
...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.js1');e.setAttribute('src',(dpi>1)?'images/butterfly-group-logo-3-960.png':'images/butterfly-group-logo-3-480.png');};
